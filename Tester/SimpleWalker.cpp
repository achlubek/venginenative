...
#define transformvector(a) fromvec4(trans*glm::vec4(a,1.0))
   ...
   // walkerScene->transformation->setOrientation(glm::quat(lookat));
    mesh_left_arm_up->getInstance(0)->transformation->setSize(glm::vec3(0.12f, 0.12f, 0.12f));
    mesh_left_arm_down->getInstance(0)->transformation->setSize(glm::vec3(0.12f, 0.12f, 0.12f));
    ...
    mesh_right_arm_up->getInstance(0)->transformation->setSize(glm::vec3(-0.12f, 0.12f, 0.12f));
    mesh_right_arm_down->getInstance(0)->transformation->setSize(glm::vec3(-0.12f, 0.12f, 0.12f));
